      ...
      <div className="border-b border-[#dac5a7]/10">
        <div className="max-w-7xl mx-auto px-8 lg:px-16 py-16">
          <div className="text-center">
            <h3 className="text-white text-2xl lg:text-3xl mb-4" style={{ fontFamily: 'Satoshi, sans-serif', fontWeight: 300 }}>
              Stay Connected
            </h3>
            <p className="text-white/70 mb-8 max-w-2xl mx-auto">
              Subscribe to my newsletter for updates on new artworks, exhibitions, and exclusive behind-the-scenes content.
            </p>
            <div className="flex flex-col sm:flex-row max-w-md mx-auto">
              ...
              />
              <button className="bg-[#dac5a7] hover:bg-[#c9b595] text-[#1a1a1a] px-6 py-3 rounded-r-full sm:rounded-l-none rounded-l-full transition-all duration-300 flex items-center justify-center gap-2 mt-2 sm:mt-0">
                <span>Subscribe</span>
      ...
      <div className="max-w-7xl mx-auto px-8 lg:px-16 py-16">
        <div className="grid lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              <div className="text-white text-2xl tracking-wider mb-4" style={{ fontFamily: 'Satoshi, sans-serif', fontWeight: 300 }}>
                Elroi <span className="text-[#dac5a7]">John Stanley</span>
              </div>
              <p className="text-white/70 leading-relaxed">
                Creating meaningful art that captures emotion and tells stories through color, form, and texture. 
                Based in Plateau State Nigeria.
              </p>
            </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="text-sm">
                ...
                <div className="text-white/60">Contemporary Visions at Metropolitan Art Gallery - Opening March 2024</div>
              </div>
              <div className="text-sm">
                <div className="text-[#dac5a7] mb-1">Commission Available</div>
                <div className="text-white/60">Currently accepting new commission projects for Spring 2024</div>
              </div>
              <div className="text-sm">
                <div className="text-[#dac5a7] mb-1">Workshop</div>
                <div className="text-white/60">Oil Painting Techniques - Online workshop coming soon</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-8 lg:px-16 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-6">
              <a href="#" className="text-white/60 hover:text-[#dac5a7] text-sm transition-colors duration-300">
                Privacy Policy
              </a>
              <a href="#" className="text-white/60 hover:text-[#dac5a7] text-sm transition-colors duration-300">
                Terms of Service
              ...
              <div className="flex items-center text-white/60 text-sm">
                Made with <Heart className="w-3 h-3 mx-1 text-[#dac5a7]" /> in Seattle
              </div>
            </div>
          </div>
        </div>
